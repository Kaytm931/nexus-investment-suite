...
description: Professional React animation skill for Awwwards/FWA-level animations using GSAP, Framer Motion, Anime.js, and Lenis. Use for premium scroll experiences, custom cursors, page transitions, text animations, parallax effects, and 60fps micro-interactions.
---
...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `neversight-skills_feed-awwwards-animations`                                |
| Version    | 1.0.1                                     |
| Author     | NeverSight                                 |
...
React-first animation Skill that delivers Awwwards/FWA-level motion using GSAP (useGSAP), Framer Motion, Anime.js and Lenis for buttery-smooth 60fps experiences. Provides reusable hooks and patterns for smooth scroll, ScrollTrigger, Lenis integration, magnetic cursor effects, reveal/stagger animations, horizontal scroll and pinned sections, page transitions, micro-interactions, and custom cursors. Built for complex scenarios including useScroll/useTransform workflows, Three.js/WebGL integration, algorithmic and generative art (fractals, L‑systems, flow fields, tessellations, Penrose tiles), kinetic typography, glitch effects and morphing text. Emphasizes proper React cleanup, SSR-friendly hooks, performance-conscious batching and requestAnimationFrame strategies. Use this Skill for premium portfolios, interactive landing pages, creative showcases and anything that requires precise timing, high frame-rate fidelity and production-ready animation architecture.
...
```bash
npx -y @lobehub/market-cli skills install neversight-skills_feed-awwwards-animations
```
...
npx -y @lobehub/market-cli skills install neversight-skills_feed-awwwards-animations --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install neversight-skills_feed-awwwards-animations --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install neversight-skills_feed-awwwards-animations --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install neversight-skills_feed-awwwards-animations --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install neversight-skills_feed-awwwards-animations --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate neversight-skills_feed-awwwards-animations --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment neversight-skills_feed-awwwards-animations -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment neversight-skills_feed-awwwards-animations
```
...
```bash
npx -y @lobehub/market-cli skills comments neversight-skills_feed-awwwards-animations
```
